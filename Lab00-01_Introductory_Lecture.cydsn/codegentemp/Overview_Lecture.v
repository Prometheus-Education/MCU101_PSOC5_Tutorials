// ======================================================================
// Overview_Lecture.v generated from TopDesign.cysch
// 01/01/2018 at 21:19
...
module ADC_SAR_v3_0_2 (
	...
	cy_clock_v1_0
		#(.id("08b6d215-626a-431f-bcd1-38f7f0dc81ea/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("08b6d215-626a-431f-bcd1-38f7f0dc81ea/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    PWM_v3_30_0 Servo_Controller (
        ...
        .ph1(Net_28),
        .ph2(Net_29));
    defparam Servo_Controller.Resolution = 8;


	cy_clock_v1_0
		#(.id("8add53ff-54cc-4dcd-af77-5bfa7654f41b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("200000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Servo_Control_Pin_net;
	wire [0:0] tmpFB_0__Servo_Control_Pin_net;
	wire [0:0] tmpIO_0__Servo_Control_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Servo_Control_Pin_net;
	electrical [0:0] tmpSIOVREF__Servo_Control_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("df4a7c0b-d6a5-4fb2-83a2-6066e7de5595"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Servo_Control_Pin
		 (.oe(tmpOE__Servo_Control_Pin_net),
		  .y({Net_34}),
		  .fb({tmpFB_0__Servo_Control_Pin_net[0:0]}),
		  .io({tmpIO_0__Servo_Control_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Servo_Control_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Servo_Control_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Servo_Control_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
